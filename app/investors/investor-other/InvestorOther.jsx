...
const InvestorOther = () => {
  ...
  const [activeMenu, setActiveMenu] = useState("Others");

  const reportData = {
    Others: [
      { year: "2024", title: "Miscellaneous Disclosure 2024" },
      { year: "2023", title: "Miscellaneous Disclosure 2023" },
      { year: "2022", title: "Miscellaneous Disclosure 2022" },
      { year: "2021", title: "Miscellaneous Disclosure 2021" },
      { year: "2020", title: "Miscellaneous Disclosure 2020" },
      { year: "2019", title: "Miscellaneous Disclosure 2019" },
      { year: "2018", title: "Miscellaneous Disclosure 2018" },
      { year: "2017", title: "Miscellaneous Disclosure 2017" },
      { year: "2016", title: "Miscellaneous Disclosure 2016" },
      { year: "2015", title: "Miscellaneous Disclosure 2015" },
      { year: "2014", title: "Miscellaneous Disclosure 2014" },
      { year: "2013", title: "Miscellaneous Disclosure 2013" },
      { year: "2012", title: "Miscellaneous Disclosure 2012" },
      { year: "2011", title: "Miscellaneous Disclosure 2011" },
      { year: "2010", title: "Miscellaneous Disclosure 2010" },
    ],
  };
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <aside className="w-full md:w-64 flex-shrink-0">
            <nav className="flex flex-col border-l border-gray-200 sticky top-8">
              {menuItems.map((item) => {
                const isActive =
                  activeMenu === item.name || activeCategory === item.name;
                return (
                  <Link
                    key={item.name}
                    href={item.link}
