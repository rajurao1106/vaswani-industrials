...
// Local static image imports (keeping these as fallbacks)
...
export default function OurProducts() {
  ...
  // Mapping slugs to either Local Imports OR Cloudinary URLs
  const imageMap = {
    "premium-sponge-iron": product2,
    "forging-ingots": product1,
    "power-division": product3,
    // New Cloudinary Images
    "billets": "https://res.cloudinary.com/drpyepp9t/image/upload/v1776426066/Billets_Production_Close_vizwrx.jpg",
    "molten-metal": "https://res.cloudinary.com/drpyepp9t/image/upload/v1776431371/Molten_Metal_Close_q5pkne.jpg",
  };
    ...
    <section className="pb-14 md:pb-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          ...
          <h2 className="text-2xl md:text-4xl font-bold mt-4">OUR PRODUCTS</h2>
          ...
          {products.map((product) => (
            ...
            >
              <div className="relative w-full h-48 md:h-56">
                <Image
                  src={imageMap[product.urlSlug] || product1}
